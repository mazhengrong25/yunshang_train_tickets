 ...
 * @LastEditTime: 2021-06-17 10:46:23
        ...
        <div className="detail_template detail_passenger">
          ...
          <div className="passenger_main">
            ...
            >
              ...
              />
              <Column title="原座位号" dataIndex="ticket_price" />
              <Column title="新座位号" dataIndex="ticket_price" />
              <Column title="原票号" dataIndex="ticket_price" />
              <Column title="新票号" dataIndex="ticket_price" />
              <Column title="票面价" dataIndex="ticket_price" />
              <Column title="服务费" dataIndex="service_price" />
              <Column title="保险" dataIndex="insurance_price" />
              <Column title="改签费" dataIndex="insurance_price" />
              <Column title="需支付" dataIndex="total_price" />
            </Table>
          </div>
        </div>
